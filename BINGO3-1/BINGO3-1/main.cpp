...
void BingoInit(int** Bingo, int Row, int Col);
void Shuffle(int** Bingo, int Row, int Col);
void Print(int** Bingo, int Row, int Col);
void InputCheck(int** Bingo, int Row, int Col, int Input);
int BINGO(int** Bingo, int Row, int Col);
